...
for j in range(0, 50): #Função que cria as bolinhas aleatóriamente, faz elas mexerem
    balls.append(Ball(10, rand.choice(cores), vector(rand.randrange(-20, 20), rand.randrange(-20, 20), rand.randrange(-20, 20)), vector(rand.randrange(-100, 100), rand.randrange(-100, 100), rand.randrange(-100, 100)), 40, j))
